...
cap = cv2.VideoCapture('D:/counting vehicles/vehicle detection and counting coures/cars2.mp4')
...
while 1:
    ...
    cvzone.putTextRect(frame,f'Entering Vehicle ={len(counter)}',[290,34],thickness=4,scale=2.3,border=2)
